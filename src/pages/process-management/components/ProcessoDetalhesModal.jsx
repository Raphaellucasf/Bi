    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 p-4 overflow-y-auto">
      ...
      <div className="bg-white rounded-xl shadow-xl w-full max-w-4xl mx-auto my-auto p-4 sm:p-6 md:p-8 relative max-h-[95vh] overflow-y-auto">
        ...
        <div className="flex border-b mb-4">
          {['Detalhes', 'Andamentos', 'Partes Contrárias', 'Faturamento', 'Documentos'].map((tab, idx) => (
        ...
        <div className="py-2">
          ...
          {aba === 3 && (
            <div>
              {/* Faturamento - Cards de Resumo */}
              <h3 className="font-bold text-lg mb-6">Resumo de Faturamento do Processo</h3>
